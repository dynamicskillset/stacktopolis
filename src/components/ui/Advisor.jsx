...
export default function Advisor({ line }) {
  ...
  return (
    <div className={`w-full bg-terminal-surface border border-terminal-border rounded-lg px-5 py-4 mt-6 flex items-start gap-5 backdrop-blur-sm ${animClass}`} style={{ boxShadow: '0 2px 8px rgba(0, 0, 0, 0.08)' }}>
